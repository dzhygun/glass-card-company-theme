# Author: https://github.com/mradugin/deploy-hugo-from-gitlab-to-cloudflare-pages
...
def main():
    ...
    print(f'Deleting obsolete {environment} page deployments, keeping {count_threshold} latest...')
    deleted_count = 0
    keep_count = 0
